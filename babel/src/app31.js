  ...
  render(date) {
    ...
    const $html = this.container.html(`
      ...
      getMonth = provOrNext => () => {
        ...
        } else if (monthIndex < month.length - 1) {
          monthIndex++;
        }
      ...
      yearProv = $html
                .find('a.year-prov')
                .on('click', () => {
                  if (yearProv.hasClass('arrow-disable')) { return; }
      ...
      yearNext = $html
                .find('a.year-next')
                .on('click', () => {
                  if (yearNext.hasClass('arrow-disable')) { return; }
      ...
      monthProv = $html
                .find('a.month-prov')
                .on('click', () => {
                  if (monthProv.hasClass('arrow-disable')) { return; }
      ...
      monthNext = $html
                .find('a.month-next')
                .on('click', () => {
                  if (monthNext.hasClass('arrow-disable')) { return; }
